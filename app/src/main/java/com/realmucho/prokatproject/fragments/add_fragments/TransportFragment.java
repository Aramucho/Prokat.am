...
public class TransportFragment extends Fragment implements View.OnClickListener {
    ...
    private EditText mTransportName, mTransportModel, mTransportEngineVolume, mTransportYear, mTransportDescription, mTransportPrice, mTransportContactsName, mTransportContactsEmail, mTransportContactsPhone, mTransportNotes;
    ...
    private void init(View view) {
        ...
        mAddButton = (Button) view.findViewById(R.id.transport_add_button);
        ...
        mTransportName = (EditText) view.findViewById(R.id.transport_mark_edit);
        mTransportModel = (EditText) view.findViewById(R.id.transport_model_edit);
        mTransportEngineVolume = (EditText) view.findViewById(R.id.transport_engine_volume_edit);
        mTransportYear = (EditText) view.findViewById(R.id.transport_year_edit);
        mTransportContactsName = (EditText) view.findViewById(R.id.transport_contacts_name);
        mTransportContactsEmail = (EditText) view.findViewById(R.id.transport_contacts_email);
        mTransportContactsPhone = (EditText) view.findViewById(R.id.transport_contacts_phone);
        mTransportNotes = (EditText) view.findViewById(R.id.transport_contacts_notes);
